...
src/execution/redirection_setup.c src/execution/redirection_utils.c src/initializing/init.c src/initializing/signals.c src/parsing/parse_env.c src/parsing/parse_input.c src/parsing/token_helper.c \
